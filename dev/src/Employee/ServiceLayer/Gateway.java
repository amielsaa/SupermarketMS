...
public class Gateway
{
    ...
    public void initDefaultData() throws Exception {
        ...
        String[] permissions = {"ManageBranch1", "ManageBranch2",
                "ManageEmployees", "ViewEmployees",                 //Employee module
                "ManageQualifications","ViewQualifications",        //
        ...
        String[] permissionsBranch1Manager = {"ManageBranch1", "ViewShift", "ViewQualifications", "ViewEmployees",
                "ViewDeliveries", "ViewInventory", "ViewOrders", "ViewSuppliers", "ManageSuppliers"};
        ...
        String[] permissionsBranch2Manager = {"ManageBranch2", "ViewShift", "ViewQualifications", "ViewEmployees",
                "ViewDeliveries", "ViewInventory", "ViewOrders", "ViewSuppliers", "ManageSuppliers"};
...
//        }
    ...
    public Response<Boolean> canManageSuppliers() {
        try {
            checkAuth("ManageSuppliers");
