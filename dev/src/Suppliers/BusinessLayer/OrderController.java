...
public class OrderController {
    ...
    public Set<LocalDate> getNextDateForDelivery(int bn, int orderId) throws DataFormatException {
        if (checkIfRoutineOrder(bn, orderId)) {
            return buildRoutineOrder(bn, orderId).getNextDateForDelivery();
        }
        throw new DataFormatException("Order was not found or not a routine Order");

    }

    public RoutineOrder getRoutineOrder(int bn, int orderId) throws DataFormatException {
        return buildRoutineOrder(bn,orderId);
    }
}
